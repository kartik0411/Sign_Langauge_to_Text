...
class Application:
    ...
    def action_call(self):
        ...
        self.tx.config(text="\nDeveloped By:", fg="red", font=("Courier", 30, "bold"))

        #self.photo3 = tk.PhotoImage(file='Pictures/asl.png')
        #self.w3=tk.Label(self.root1, image=self.photo3)
        #self.w3.place(x=10, y=70)
        self.tx3=tk.Label(self.root1)
        self.tx3.place(x=170, y=100)
        self.tx3.config(text="\n\nKartik Sharma\n9917103047\n\nAshutosh Choudhary\n9917103045\n\nChandragupta Mishra\n9917103048\n\n\n\nUnder the Supervision of\n\nDr. Gaurav Kumar Nigam", font=("Courier", 30, "bold"))
